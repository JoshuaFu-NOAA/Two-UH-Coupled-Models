MODULE mo_buffer_fft
  ...
  !
  REAL, ALLOCATABLE, TARGET :: fftz  (:,:,:,:) ! the fft is performed in fftz
...
CONTAINS
  ...
  TYPE (pe_decomposed), INTENT(in) :: dc   ! decomposition table
    ...
    !
    ALLOCATE (lbm0 (            dc% nflev  , dc% nlat,  nva1))
