MODULE mo_mpi
  !
  ! $Id: mo_mpi.f90,v 1.37 2000/04/10 21:12:10 m214030 Exp $
  !
...
!c=========================================================================c
!qbao modify for (kuroshio) apcc2 machine Nov 29, 2005
!fu++       iope = 0
!qbao
!c=========================================================================c
    ...
    WRITE (nerr,'(a,i4)') '  pointer        :', p_int_cp
...
&                          flag, p_status, p_error)
  ...
  SUBROUTINE p_wait
    ...
    DO i = 2, p_irequest
        CALL MPI_WAIT(p_request(i-1), p_status, p_error)
    END DO 
    p_irequest = 1
#endif
