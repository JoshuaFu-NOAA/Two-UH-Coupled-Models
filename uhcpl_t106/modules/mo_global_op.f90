MODULE mo_global_op
!
!+ $Id: mo_global_op.f90,v 1.11 1999/09/15 09:26:24 m214003 Exp $
!
...
!------------------------------------------------------------------------------
  ...
  !
  REAL ,INTENT (in) :: x(:,:,:)
  REAL              :: maxval_zonal3 (SIZE(x,2), SIZE(x,3))
...
!------------------------------------------------------------------------------
  ...
  !
  REAL ,INTENT (in) :: x(:,:,:)
  REAL              :: minval_zonal3 (SIZE(x,2), SIZE(x,3))
