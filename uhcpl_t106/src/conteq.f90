...
!  scheme.
!+ $Id: conteq.f90,v 1.5 1999/07/01 08:40:08 m214030 Exp $

SUBROUTINE conteq(pdt,kdimt,pdlnps,pdiv,kdimd,klen,lpperm)
  ...
  !   *kdimt*     *first dimension of 2-d array *pdt*.
  !   *pdlnps*    *computed increment of ln(surface pressure).
  !   *pdiv*      *specified divergence.
  !   *kdimd*     *first dimension of 2-d array *pdiv*.
  ...
  !  Scalar arguments 
  INTEGER :: kdimd, kdimt, klen
  LOGICAL :: lpperm

  !  Array arguments 
  REAL :: pdiv(kdimd,*), pdlnps(*), pdt(kdimt,*)
