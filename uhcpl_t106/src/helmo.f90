...
!+ $Id: helmo.f90,v 1.10 1999/08/23 09:14:26 m214030 Exp $
...
SUBROUTINE helmo(kdt)
  ...
  !
  ! *helmo* is called first from *initialise*: call *helmo*(1).
  ...
  do i=1,nns
     ...
     DO jl = 1, nlev
        DO jll = 1, nlev
           ...
           IF (jl==jll) zb(jl,jll) = zb(jl,jll) + 1.
        END DO
     END DO
